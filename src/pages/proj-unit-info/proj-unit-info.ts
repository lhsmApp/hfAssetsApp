...
/**
 * Generated class for the ProjUnitInfoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-proj-unit-info',
  templateUrl: 'proj-unit-info.html',
})
export class ProjUnitInfoPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ProjUnitInfoPage');
    this.itemShow = new ProjectUnitDetail();
    this.getShowItem();
  }
