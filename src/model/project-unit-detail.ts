export class ProjectUnitDetail{    
			...
			payMoney: number;//已付款金额",传double型               
              	...
              	designFinishTime: string;//设计完成时间"    工程开工时间
              	drawingFinishTime: string;//施工图完成时间"  桩基施工完毕时间
              	planBeginTime: string;//计划开工时间"      基础施工完毕时间
 			planEndTime: string;//计划完工时间"         主体施工完毕时间
 			realBeginTime: string;//实际开工时间"       工程竣工时间
 			realEndTime: string;//实际完工时间"         
 			realFinishTime: string;//竣工验收时间"      
 			certainDate: string;//预达转资时间"          预达转资时间
