...
export const APP_SERVE_IP = '192.168.1.110';
...
export const IS_DEPT_CHANGE = 'isDeptChange';//是否已经变换过部门//用于待办事项页切换
export const IS_DEPT_CHANGE1 = 'isDeptChange1';//是否已经变换过部门//用于图表页切换
